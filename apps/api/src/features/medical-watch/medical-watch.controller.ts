import { Controller, Get, HttpCode, HttpStatus, Patch, Post, Query, Body, UseGuards } from '@nestjs/common';
...
import { MedicalWatchPreferencesResponseDto, UpdateMedicalWatchPreferencesRequestDto } from './dtos/requests/medical-watch-preferences.request.dto';
...
export class MedicalWatchController {
  ...
  @Patch('preferences')
  updatePreferences(@CurrentUser('id') userId: string, @Body() dto: UpdateMedicalWatchPreferencesRequestDto): Promise<MedicalWatchPreferencesResponseDto> {
