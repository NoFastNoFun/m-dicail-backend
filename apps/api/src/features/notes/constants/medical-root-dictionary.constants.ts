...
// Portage du dictionnaire de racines gréco-latines du front
// (lib/core/medical_terms/medical_root_dictionary.dart + assets/medical_terms/greco_latin_roots.json)
export const PREFIXES_ANATOMIQUES: MedicalRoot[] = [
...
export const PREFIXES_REGIONS: MedicalRoot[] = [
...
export const PREFIXES_DIRECTION: MedicalRoot[] = [
...
export const SUFFIXES_PATHOLOGIQUES: MedicalRoot[] = [
...
export const KNOWN_PATHOLOGY_TERMS: string[] = [
  'lombalgie',
  'cervicalgie',
  'dorsalgie',
  'myalgie',
